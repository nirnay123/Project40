                ...
                player.getPlayerAtEnd();
                 ...
                 for(var plr in allPlayers){
                     ...
                     if(index === player.index){
                        ...
                        //text(player.name, player+player.index.position.x, player+player.index.position.y);
                        text(allPlayers.player1.name,player1.x-50,player1.y);
                        text(allPlayers.player2.name,player2.x-50,player2.y);          
                     }
